...
public interface SponsorRepository extends JpaRepository<Sponsor, Long> {
    ...
    @Query("SELECT s.id AS id, s.name AS name, sc.primaryContact AS primaryContact, sc.secondaryContact AS secondaryContact, " +
            "c.firstName AS firstName, c.lastName AS lastName, c.informalName AS informalName " +
            "FROM Sponsor s " +
